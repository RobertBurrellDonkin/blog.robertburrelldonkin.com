...
import {GCP, Scala} from "../../src/components/LifelongLearning";

Go big or go home, they used to say. But now we're all at home I suppose that we're supposed to just "Go Big"...
